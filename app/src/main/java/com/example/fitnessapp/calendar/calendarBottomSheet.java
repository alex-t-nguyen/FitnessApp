...
public class calendarBottomSheet extends BottomSheetDialogFragment implements calendar_list_item_Adapter.onCalItemListener {
    ...
    public void onCalendarItemClick(int position) {
        ...
        final EditText dialogTitle = (EditText) mDialog.findViewById(R.id.dialogTitle);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        // Initialize Widgets
        bottomSheetTitle = (TextView)v.findViewById(R.id.bottomSheetTitle);
        fabAdd = (FloatingActionButton)v.findViewById(R.id.calendarFAB);
