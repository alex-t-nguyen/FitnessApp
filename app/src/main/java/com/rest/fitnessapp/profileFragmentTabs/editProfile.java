...
import com.rest.fitnessapp.profileFragmentTabs.DeleteAccount.deleteAuthenticate;
import com.rest.fitnessapp.profileFragmentTabs.editEmail.change_email_authenticate;
...
public class editProfile extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // defining Cards
        editEmailCard = findViewById(R.id.edit_email_btn);
        deleteAccountCard = findViewById(R.id.delete_account_btn);
