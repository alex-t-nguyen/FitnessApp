package com.rest.fitnessapp.profileFragmentTabs.DeleteAccount;
...
import com.rest.fitnessapp.profileFragmentTabs.editProfile;
...
public class deleteAuthenticate extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        password = findViewById(R.id.passwordConfirm);
        deletebtn = findViewById(R.id.delete_acc_confirm_btn);
        cancelbtn = findViewById(R.id.cancel_acc_confirm_btn);

        fbreauthbtn = findViewById(R.id.facebook_reauthenticate);
