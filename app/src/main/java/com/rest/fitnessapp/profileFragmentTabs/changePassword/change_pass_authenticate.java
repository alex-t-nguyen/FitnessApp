...
public class change_pass_authenticate extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Instantiate widgets
        emailConfirm = findViewById(R.id.emailConfirm_forPassword);
        passwordConfirm = findViewById(R.id.passwordConfirm_forPassword);
        submitConfirm = findViewById(R.id.submit_changepass_btn);
        cancelConfirm = findViewById(R.id.cancel_changepass_btn);
        progressBar = findViewById(R.id.progressbar_passAuthenticate);
