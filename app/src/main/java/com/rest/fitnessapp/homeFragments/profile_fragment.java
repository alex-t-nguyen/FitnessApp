...
import com.rest.fitnessapp.profileFragmentTabs.changePassword.change_pass_authenticate;
...
public class profile_fragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        helpclick= view.findViewById(R.id.help);
        notification= view.findViewById(R.id.notifications);
        changePassbtn = view.findViewById(R.id.change_password);
